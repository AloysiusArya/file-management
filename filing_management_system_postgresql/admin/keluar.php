...
if (isset($_POST['submit'])) {
    $nomor_surat = pg_escape_string($_POST['nomor_surat']);
    $tujuan_permohonan = pg_escape_string($_POST['tujuan_permohonan']);
    $alamat_tujuan = pg_escape_string($_POST['alamat_tujuan']);
    $perihal = pg_escape_string($_POST['perihal']);
    $tanggal = pg_escape_string($_POST['tanggal']);
    $divisi = pg_escape_string($_POST['divisi']);
    $jenis_surat = pg_escape_string($_POST['jenis_surat']);
    $tipe_surat = pg_escape_string($_POST['tipe_surat']);
...
if (isset($_POST['edit'])) {
    $id_surat = pg_escape_string($_POST['id_surat']);
    $nomor_surat = pg_escape_string($_POST['nomor_surat']);
    $tujuan_permohonan = pg_escape_string($_POST['tujuan_permohonan']);
    $alamat_tujuan = pg_escape_string($_POST['alamat_tujuan']);
    $perihal = pg_escape_string($_POST['perihal']);
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataX" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $stmt = $conn->prepare("SELECT * FROM surat WHERE tipe_surat = 'Surat Keluar'");
                                        $stmt->execute();
